...
public class InmobiliariaGUI extends JFrame {
    ...
    public InmobiliariaGUI() {
        ...
        itemRegistrarArrendatario.addActionListener(new ActionListener() {
        ...
        itemEliminarArrendatario.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        itemModificarArrendatario.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        itemRegistrarPropiedad.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        itemEliminarPropiedad.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        itemModificarPropiedad.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
        ...
        itemGestionarAlquileres.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
